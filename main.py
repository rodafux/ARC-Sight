...
class SettingsWindow(QDialog):
    ...
    def init_ui(self, current_notify_min):
        ...
        lbl_ver = QLabel("Version: <b>1.0.3</b>")
...
class HudEventCard(QFrame):
    ...
    def update_display(self):
        ...
        if self.is_active: 
            new_color = "#ff5500" 
        elif total_seconds <= NOTIFY_SECONDS: 
            new_color = "#ff5500" if self.flash_toggle else "#ffffff" 
        else: 
            new_color = "#cccccc" 
...
class MainWindow(QMainWindow):
    ...
    def setup_tray_icon(self):
        ...
        if os.path.exists(icon_settings_path):
